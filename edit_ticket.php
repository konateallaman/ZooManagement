...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // ...process other form fields and update ticket record in database...
    $sql = "UPDATE tickets SET ticket_type='$ticket_type', ticket_price='$ticket_price',Quantity='$quantity' WHERE ticket_id='$ticket_id'";
    $result = $conn->query($sql);
    // Redirect user back to ticket list page
    header("Location:View_Total_Paid_Tickets.php");
    exit();
} else {
    // Display form with existing ticket data
    $ticket_id = $_GET["id"];
...
?>
        <div class="container mt-4">
            <h1 class="mb-4" style="color: #00ff40">Edit Ticket</h1>
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ticket_type" name="ticket_type" value="<?php echo $row["ticket_type"]; ?>">
                </div>
